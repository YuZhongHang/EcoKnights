...
class ColorsManager {
  static const Color mainBlue = Color(0xFF46707E);
  static const Color gray = Color(0xFF6B8B81);
  static const Color gray93Color = Color(0xFFEDEDED);
  static const Color gray76 = Color(0xFFC2C2C2);
  static const Color darkBlue = Color(0xFF22393C);
  ...
  static const Color lightYellow = Color(0xFFE2E1CF);
}
